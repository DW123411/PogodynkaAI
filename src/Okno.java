        ...
        // ????? 
         ...
         //         klasyfikacja_z_pliku.setToolTipText("<html>Wczytaj dane wejściowe<br />z pliku</html>");                
            ...
            if(daneWejsciowe!=null){
                 ...
                 int a = JOptionPane.showConfirmDialog(this, "Czy zastąpić aktualnie wczytane dane?", "Uwaga!", JOptionPane.ERROR_MESSAGE, JOptionPane.WARNING_MESSAGE); 
           if(a==0){       
               nadpis = true; 
            ...
            if (spr) {
                ...
                daneWejsciowe2 = Wczytywanie.wczytajKlasyfikacjeZPliku(sciezkaDoPliku);
                  wyswietlanie.getDecyzja(indukcja.getKorzen());
                            ...
                            daneWejsciowe2 = Wczytywanie.wczytajKlasyfikacjeZPliku(sciezkaDoPliku);
                         JOptionPane.showMessageDialog(null, "Wczytano dane. Brak drzewa decyzyjnego, aby wyświetlić decyzję: Narysuj drzewo, a następnie wczytaj ponownie dane lub wybierz przycisk 'Wyświetl decyzję'.");
...
//        } }
//        
            String[] egsd = {"Drzewo", "Tabele", "Wszystko", "Anuluj"};
int motyw = JOptionPane.showOptionDialog(null, "Co wymazać ?", "UWAGA ! Czyszczenie.", JOptionPane.PLAIN_MESSAGE, JOptionPane.PLAIN_MESSAGE, null , egsd,null);
