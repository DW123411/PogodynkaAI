...
public class TableRenderDemo extends JPanel {
    String[] dane_wejsciowe_kolumny;
    Object[][] dane_wejsciowe_dane;
    ...
    public TableRenderDemo(DaneWejsciowe k) {
        ...
        setUpSportColumn(table, 0);
        setUpSportColumn(table, 1);
        setUpSportColumn(table, 2);
        setUpSportColumn(table, 3);
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        public boolean isCellEditable(int row, int col) {
            ...
            //             }
            String decision = "Decision";
            if (decision.equals(getColumnName(col))) {
                return false;
            }
